<template>
  ...
  <div :class="className" :id="yearPresstemp" :style="{height:height,width:width}"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      initChart() {
        this.chart = echarts.init(document.getElementById(this.yearPresstemp))
        const days = [];
        this.dataList = [];
        this.xdata = [];
        this.avgData = 0;
        ...
        this.$http({
          url: this.$http.adornUrl(`/collect/line/templd/3/` + date),
          method: 'get',

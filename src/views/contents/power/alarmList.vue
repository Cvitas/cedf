<template>
  <div class="mod-role">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="提醒项名称">
        <el-input v-model="dataForm.name" placeholder="提醒项名称" clearable></el-input>
      </el-form-item>

      <el-form-item>
        <el-button @click="getDataList()" type="warning">查询</el-button>
        <el-button type="primary" @click="addOrUpdateHandle()">提醒项设置</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="statusHandle(scope.row)" class="el-button--text-gray">
            <span style="color: blue">{{scope.row.status?'停用':'启用'}}</span>
          </el-button>
        </template>
      </el-table-column>
    </el-table>

  ...
  <div class="mod-user">
    <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
      <el-table-column label="当前提醒" header-align="center" align="center" style="color:red">
        ...
        <el-table-column prop="tipTime" header-align="center" align="center" label="提醒时间"/>
      </el-table-column>
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" class="el-button--text-gray" @click="deleteHandle(scope.row.id)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-table :data="dataListAlarm" border v-loading="dataListLoading" style="width: 100%;">
      <el-table-column label="设置的提醒项" header-align="center" align="center" style="color:red">
        ...
        <el-table-column prop="quartz" header-align="center" align="center" label="提醒周期"/>
      </el-table-column>
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" class="el-button--text-gray" @click="editHandle(scope.row.id)">编辑
          </el-button>
          <el-button type="text" size="small" class="el-button--text-gray" @click="deleteHandle(scope.row.id)">删除
          </el-button>
        </template>
